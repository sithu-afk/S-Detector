...
In compliance with Mozilla's data collection transparency requirements, S_Detector declares **browsingActivity** as required data collection in its manifest, corresponding exactly to the behavior described above: the destination URL of your active navigation is sent to Google Safe Browsing for a real-time check. Firefox displays this disclosure to you before installation.
